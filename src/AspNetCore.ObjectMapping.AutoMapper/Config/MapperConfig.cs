using AspNetCore.ObjectMapping.AutoMapper.Models;
using AspNetCore.ObjectMapping.AutoMapper.Profiles;
using AspNetCore.ObjectMapping.AutoMapper.ViewModel;
using AutoMapper;

namespace AspNetCore.ObjectMapping.AutoMapper.Config;
