...
using AspNetCore.Authentication.Identity.Helpers;
...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> GetLinkConfirmEmail([EmailAddress] string email, string returnUrl = null)
    {
        ...
        var emailConfirmationUrl = Url.Link("ConfirmEmail", new { userId, code, returnUrl });
    ...
    public async Task<IActionResult> ExternalLogin(string provider, string returnUrl = null)
    {
        ...
        var redirectUrl = Url.Link("ExternalLoginCallback", new { returnUrl });
    ...
    public async Task<IActionResult> ExternalLoginAndRegister(string provider, string returnUrl = null)
    {
        ...
        // Request a redirect to the external login provider.
        var redirectUrl = Url.Link("ExternalLoginAndRegisterCallback", new { returnUrl });
        var properties = _signInManager.ConfigureExternalAuthenticationProperties(provider, redirectUrl);
        return Challenge(properties, provider);
        //return new ChallengeResult(provider, properties);
    }
